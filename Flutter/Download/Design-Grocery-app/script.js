...
downloadButton.addEventListener("click", () => {
  ...
  $(document).ready(function () {
      $("button").click(function (event) {
          ...
          CopyToClipboard("Download Design BCA Mobile | Stack Image Link : https://stackimage.github.io/Download/Design-Grocery-app/", true, "Value copied");
      });
  });
  ...
  const shareData = {
    title: 'Stack Image',
    text: 'Download Design Grocery App | Stack Image Link : ',
    url: 'https://stackimage.github.io/Download/Design-Grocery-app/'
  }

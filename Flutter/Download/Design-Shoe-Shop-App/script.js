...
downloadButton.addEventListener("click", () => {
  ...
  $(document).ready(function () {
      $("button").click(function (event) {
          ...
          CopyToClipboard("Design Shoe Shop App | Stack Image Link : https://stackimage.github.io/Download/Design-Shoe-Shop-App/", true, "Value copied");
      });
  });
  ...
  const shareData = {
    title: 'Stack Image',
    text: 'Download Design Shoe Shop App | Stack Image Link : ',
    url: 'https://stackimage.github.io/Download/Design-Shoe-Shop-App/'
  }

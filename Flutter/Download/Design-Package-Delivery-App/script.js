...
downloadButton.addEventListener("click", () => {
  ...
  $(document).ready(function () {
      $("button").click(function (event) {
          ...
          CopyToClipboard("Design Package Delivery App | Stack Image Link : https://stackimage.github.io/Download/Design-Package-Delivery-App/", true, "Value copied");
      });
  });
  ...
  const shareData = {
    title: 'Stack Image',
    text: 'Download Design Package Delivery App | Stack Image Link : ',
    url: 'https://stackimage.github.io/Download/Design-Package-Delivery-App/'
  }

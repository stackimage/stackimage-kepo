...
downloadButton.addEventListener("click", () => {
  ...
  $(document).ready(function () {
      $("button").click(function (event) {
          ...
          CopyToClipboard("Download Design Hotel Booking App | Stack Image Link : https://stackimage.github.io/Download/Design-Hotel-Booking-App/", true, "Value copied");
      });
  });
  ...
  const shareData = {
    title: 'Stack Image',
    text: 'Download Design Hotel Booking App | Stack Image Link : ',
    url: 'https://stackimage.github.io/Download/Design-Hotel-Booking-App/'
  }

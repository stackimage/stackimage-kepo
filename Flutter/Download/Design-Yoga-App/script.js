...
downloadButton.addEventListener("click", () => {
  ...
  $(document).ready(function () {
      $("button").click(function (event) {
          ...
          CopyToClipboard("Design Yoga App | Stack Image Link : https://stackimage.github.io/Download/Design-Yoga-App/", true, "Value copied");
      });
  });
  ...
  const shareData = {
    title: 'Stack Image',
    text: 'Download Design Yoga App | Stack Image Link : ',
    url: 'https://stackimage.github.io/Download/Design-Yoga-App/'
  }

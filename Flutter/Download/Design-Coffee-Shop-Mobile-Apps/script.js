...
downloadButton.addEventListener("click", () => {
  ...
  $(document).ready(function () {
      $("button").click(function (event) {
          ...
          CopyToClipboard("Download Design Coffee Shop Mobile Apps | Stack Image Link : https://stackimage.github.io/Download/Design-Coffee-Shop-Mobile-Apps/", true, "Value copied");
      });
  });
  ...
  const shareData = {
    title: 'Stack Image',
    text: 'Download Design Coffee Shop Mobile Apps | Stack Image Link : ',
    url: 'https://stackimage.github.io/Download/Design-Coffee-Shop-Mobile-Apps/'
  }

    ...
    downloadBtn.addEventListener("click", () => {
      ...
      var downloadTimer = setInterval(function timeCount(){
        ...
        if(timeLeft <= 0){
          ...
          let download_href = "Design Mobile ticket booking apps - Stack Image.rar"; //enter the downloadable file link URL here
...
link.href = 'https://wa.me/?text=Download Design Mobile ticket booking apps | Stack Image https://www.stackimage.my.id/File/Download-Design/Design-Mobile-ticket-booking-apps/';
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://telegram.me/share/url?text=Download Design Mobile ticket booking apps | Stack Image Image&url=https://www.stackimage.my.id/File/Download-Design/Design-Mobile-ticket-booking-apps/';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
// share telegram

    ...
    downloadBtn.addEventListener("click", () => {
      ...
      var downloadTimer = setInterval(function timeCount(){
        ...
        if(timeLeft <= 0){
          ...
          let download_href = "Design Wallet App Ui - Stack Image.rar"; //enter the downloadable file link URL here
...
link.href = 'https://wa.me/?text=Download Design Wallet App Ui | Stack Image https://www.stackimage.my.id/File/Download-Design/Design-Wallet-App-Ui/';
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://telegram.me/share/url?text=Download Design Wallet App Ui | Stack Image Image&url=https://www.stackimage.my.id/File/Download-Design/Design-Wallet-App-Ui/';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
// share telegram

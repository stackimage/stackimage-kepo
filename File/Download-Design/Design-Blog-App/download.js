...
link.href = 'https://wa.me/?text=Download Design Blog App | Stack Image https://www.stackimage.my.id/File/Download-Design/Design-Blog-App/';
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://telegram.me/share/url?text=Download Design Blog App | Stack Image Image&url=https://www.stackimage.my.id/File/Download-Design/Design-Blog-App/';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
// share telegram
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://mail.google.com/mail/?view=cm&to=%7Bemail_address%7D&su=Download%20Design%20Blog%20App%20%7C%20Stack%20Image&body=https://www.stackimage.my.id/File/Download-Design/Design-Blog-App/&bcc=%7Bemail_address%7D&cc=%7Bemail_address%7D';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
/* Gmail */

...
downloadBtn.addEventListener("click", () => {
  ...
  var downloadTimer = setInterval(function timeCount() {
    ...
    if (timeLeft <= 0) {
      ...
      let download_href = "Icon Tiktok -Stack Image.rar"; //enter the downloadable file link URL here
...
link.href = 'https://wa.me/?text=Download Icon Tiktok | Stack Image https://www.stackimage.my.id/File/Download-Icon/Icon-TIktok/';
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://telegram.me/share/url?text=Download Icon Tiktok | Stack Image&url=https://www.stackimage.my.id/File/Download-Icon/Icon-TIktok/';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
// share telegram

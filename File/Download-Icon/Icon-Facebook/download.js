...
downloadBtn.addEventListener("click", () => {
  ...
  var downloadTimer = setInterval(function timeCount() {
    ...
    if (timeLeft <= 0) {
      ...
      let download_href = "Icon Facebook - Stack Image.rar"; //enter the downloadable file link URL here
...
link.href = 'https://wa.me/?text=Download Icon Facebook | Stack Image https://www.stackimage.my.id/File/Download-Icon/Icon-Facebook/';
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://telegram.me/share/url?text=Download Icon Facebook | Stack Image&url=https://www.stackimage.my.id/File/Download-Icon/Icon-Facebook/';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
// share telegram

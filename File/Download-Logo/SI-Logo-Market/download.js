    ...
    downloadBtn.addEventListener("click", () => {
      ...
      var downloadTimer = setInterval(function timeCount(){
        ...
        if(timeLeft <= 0){
          ...
          let download_href = "SI Logo Market - Stack Image.rar"; //enter the downloadable file link URL here
...
link.href = 'https://wa.me/?text=Download SI Logo Market | Stack Image https://www.stackimage.my.id/File/Download-Logo/SI-Logo-Market/';
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://telegram.me/share/url?text=Download SI Logo Market | Stack Image Image&url=https://www.stackimage.my.id/File/Download-Logo/SI-Logo-Market/';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
// share telegram

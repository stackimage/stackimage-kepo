    ...
    downloadBtn.addEventListener("click", () => {
      ...
      var downloadTimer = setInterval(function timeCount(){
        ...
        if(timeLeft <= 0){
          ...
          let download_href = "SI Logo The Miracle - Stack Image.rar"; //enter the downloadable file link URL here
...
link.href = 'https://wa.me/?text=Download SI Logo The Miracle | Stack Image https://www.stackimage.my.id/File/Download-Logo/SI-Logo-The-Miracle/';
...
var parent = element.parentNode;
var link = document.createElement('a');
link.href = 'https://telegram.me/share/url?text=Download SI Logo The Miracle | Stack Image Image&url=https://www.stackimage.my.id/File/Download-Logo/SI-Logo-The-Miracle/';
link.appendChild(element.cloneNode(true));
parent.replaceChild(link, element);
// share telegram
